        ...
        <div className="song-item-details-cont  w-[100%] h-auto">
          ...
          <div className="song-item-price-cont py-3 px-2 flex justify-between">
            ...
            <div className="song-item-cart flex border-2 border-[#b9b9b97c]  rounded-[5px] overflow-hidden">
              <div onClick={handleDecrement} className="decrement-cont  border-r-2 border-[#b9b9b97c] h-6 w-6 flex justify-center items-center text-3xl">-</div>
              <div className="count-cont h-6 w-6 flex justify-center items-center" > {productCount} </div>
              <div onClick={handleIncrement} className="increment-cont border-l-2 border-[#b9b9b97c] h-6 w-6 flex justify-center items-center text-2xl">+</div>
            </div>
          </div>
        </div>
      </div>
